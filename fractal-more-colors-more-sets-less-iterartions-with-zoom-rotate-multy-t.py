...
def display_and_rotate_fractal():
    ...
    angle = 0
    while True:  # Infinite loop to continually cycle through fractals and rotate the display
        ...
        for _ in range(1000):  # Zoom steps per fractal
        ...
        # Rotate the display 90 degrees after every fractal set
        angle = (angle + 90) % 360
        sense.set_rotation(angle)

try:
    display_and_rotate_fractal()
